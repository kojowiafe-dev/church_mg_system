    ...
    try {
      ...
      const formattedData = {
        ...
        baptism_date: formData.baptism_date
          ? new Date(formData.baptism_date).toISOString().split("T")[0]
          : null,
        membership_date: formData.membership_date
          ? new Date(formData.membership_date).toISOString().split("T")[0]
          : null,
      };
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onChange={(e) =>
                        handleDateChange("date_of_birth", e.target.value)
                      }
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onChange={(e) =>
                        handleDateChange("baptism_date", e.target.value)
                      }
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      onChange={(e) =>
                        handleDateChange("membership_date", e.target.value)
                      }
                      className="block w-full p-4 cursor-pointer rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    />
                  </div>
